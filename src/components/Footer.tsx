            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <div className="flex gap-4">
                        <a href={CONTACT_INFO.socials.facebook} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-gold hover:text-white transition-colors text-gray-300">
                            <Facebook size={18} />
                        </a>
                        <a href={CONTACT_INFO.socials.instagram} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-gold hover:text-white transition-colors text-gray-300">
                            <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"></line></svg>
                        </a>
                        <a href={CONTACT_INFO.socials.twitter} target="_blank" rel="noopener noreferrer" className="p-2 bg-gray-800 rounded-full hover:bg-gold hover:text-white transition-colors text-gray-300">
                    ...
                    <div className="mt-8">
                        ...
                        <div className="flex items-center gap-3">
                            <a href="https://gredaghana.org/" target="_blank" rel="noopener noreferrer" className="bg-white p-2 rounded-lg h-12 w-auto flex items-center justify-center hover:scale-105 transition-transform">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        {[
                            ...
                            { name: 'Why Invest With Us', path: '/why-invest' },
                            { name: 'Insight & News', path: '/insight' },
